                    ...
                    {services.slice(0, 3).map((service, index) => (
                        ...
                        >
                            <Link href={`/services/${service.slug}`} className="block h-full">
                                <div className="relative h-[500px] w-full overflow-hidden rounded-[2rem] border border-white/5 bg-[#121212] transition-all duration-500 hover:border-primary/50 group-hover:shadow-[0_20px_40px_-15px_rgba(59,130,246,0.2)]">
                                    ...
                                    <div className="absolute inset-0 flex flex-col justify-end p-8 z-20">
                                        <div className="transform transition-all duration-300 group-hover:-translate-y-2">
                                            <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/5 border border-white/10 text-primary backdrop-blur-md group-hover:bg-primary group-hover:text-white transition-colors">
                                                <ArrowUpRight className="w-5 h-5" />
                                            </div>

                                            <h3 className="text-2xl font-bold text-white mb-3 leading-tight font-heading group-hover:text-primary transition-colors">
                                                {service.title}
                                            </h3>
